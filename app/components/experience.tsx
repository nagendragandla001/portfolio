...
const experiences = [
  {
    ...
    achievements: [
      ...
      "Building type-safe forms with React Hook Form and Zod in Next.js",
      "Integrated SSO/OAuth authentication via PingFederate for secure user access",
      "Developed server components and client components to optimize rendering performance",
      "Built API routes within the App Directory to handle backend interactions seamlessly",
      "Implemented dynamic routing, nested layouts, and parallel routes for complex UI flows",
      "Drive frontend architecture decisions, enforce coding standards, and guide best practices across the team",
      "Conduct code reviews, enforce best practices, and ensure the quality of the codebase",
      "Optimize application performance using Dynatrace to proactively identify bottlenecks",
      "Lead the implementation of unit tests with React Testing Library (RTL) and E2E tests with Cypress",
      "Continuously improve the development process through Docker automation, CI/CD, and dev tooling enhancements",
    ],
    tags: [
      "Next.js",
      "React",
  ...
  },
  {
    ...
    company: "NOL-Singapore (via Accenture)",
    period: "Jul 2014 - Aug 2016",
    location: "Singapore",
    description:
      "Developed Logistics Super Suite (LSS), a comprehensive logistics management platform for a major Singapore-listed shipping company. Built end-to-end modules for Booking, Purchase Orders, User and Customer Onboarding, Product Tracking, and Master Data Management, enabling seamless shipment booking, workflow management, and real-time product tracking across global supply chains.",
    achievements: [
      "Involved in designing the UI layer using HTML5, CSS3, and Bootstrap",
      "Developed Directives, Services, Factories, and Filters using AngularJS to build reusable and modular components",
      "Developed and integrated RESTful APIs using Node.js for supporting logistics workflows and application features",
      "Implemented Node.js clustering to improve server scalability and handle concurrent requests efficiently",
      "Designed and implemented MongoDB collections and document schemas using Mongoose",
      "Created dynamic data structures in MongoDB to support configurable fields used in custom AngularJS directives",
    ],
    tags: [
      "AngularJS",
      "Node.js",
